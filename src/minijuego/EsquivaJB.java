 ...
 * @author kevin2
 */
public class EsquivaJB extends Thread {

    JLabel eti;
    InterfazPacman jf;

    public EsquivaJB(JLabel eti, InterfazPacman jf) {
        this.eti = eti;
        this.jf = jf;
    }
            ...
            if (Pacman.noPastillas == 0) {
                ...
                try {
                    ...
                    if (Manipula.topeXY(jf.getLblFantasmaRojo(), jf.getLblPacman())
                        ...
                        if (Manipula.topeXY(jf.getLblFantasmaRojo(), jf.getLblPacman())) {
                            Manipula.tocaFantasma1(this.jf, Pacman.hiloB);
                        } else if (Manipula.topeXY(jf.getLblFantasmaAzul(), jf.getLblPacman())) {
                            Manipula.tocaFantasma2(this.jf, Pacman.hiloB);
                        } else if (Manipula.topeXY(jf.getLblFnatasmaNaranja(), jf.getLblPacman())) {
                            Manipula.tocaFantasma3(this.jf, Pacman.hiloB);
                        } else {
                            Manipula.tocaFantasma4(this.jf, Pacman.hiloB);
                        }
                    } else if (this.eti.getY() > 650) {
